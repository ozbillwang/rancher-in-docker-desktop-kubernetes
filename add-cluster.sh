...
URL="$1"
K8S_CLUSTER_NAME="${2:-docker-desktop}"
PASSWORD="password"
...
# Create cluster
CLUSTERRESPONSE=`cURL -s "https://${URL}/v3/cluster" -H 'content-type: application/json' -H "Authorization: Bearer $APITOKEN" --data-binary '{"type":"cluster","name":"'${K8S_CLUSTER_NAME}'","import":true}' --insecure`
